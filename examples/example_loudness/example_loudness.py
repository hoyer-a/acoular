"""Example "Loudness".
using Staionary Loudness Class and time domaine beamforming

Demonstrates different features of Loudness Class and refering Plots

Uses generated data three sources
...
bct = acoular.BeamformerCleant(source=fct, steer=st, n_iter=20, damp=0.7)
...
bcts = acoular.BeamformerCleantSq(source=fcts, steer=st, n_iter=20, damp=0.7, r_diag=True)
